...
.constant('mbTilesURL', 'http://10.0.2.2:7777/map.mbtiles')
    .constant('streetsURLTest', 'http://10.0.2.2:7777/streets.json')
    .constant('orgsURLTest', 'http://10.0.2.2:7777/orgs.json')
    .constant('buildingsURLTest', 'http://10.0.2.2:7777/buildings.json')
